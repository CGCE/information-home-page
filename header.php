...
<html>
<head>
<title class='CJLabel' data-label='titre'>Columbia Global Centers | Europe</title>
...
<header>
  ...
  <nav id='flag'>
  	...
  	<img src='css/img/french_flag.jpg' alt='Fran&ccedil;ais' border='0' class='CJFlag CJFlagFR' data-lang='fr' />
  </nav> <!-- flag -->
  <hr/>
</header>
