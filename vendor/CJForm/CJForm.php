  ...
  public function CJForm(){
	...
	public function inputDates($id,$required=false,$hours=false,$multiple=1){
		...
		for($j=0;$j<$multiple;$j++){
			...
			if($j>0){
				$this->elem[]="<img src='css/img/delete.png' alt='delete' class='CJFormDeleteDate CJLabel' data-label='delete' />";
			}
		...
		if($multiple>1){
			$this->elem[]="<tr><td></td><td><img src='css/img/add.png' alt='ajouter' class='CJFormAddDate CJLabel' data-label='ajouter' />";
